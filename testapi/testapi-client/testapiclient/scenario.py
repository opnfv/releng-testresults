...
class ScenarioGet(ScenarioBase):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument('-scenario_version', type=str, help='Search scenarios using version')
    ...
    def take_action(self, parsed_args):
        ...
        if(parsed_args.scenario_version):
            req_url += "version=" + parsed_args.scenario_version + "&"
...
class ScenarioGetOne(ScenarioBase):

    def get_parser(self, prog_name):
        parser = super(ScenarioGetOne, self).get_parser(prog_name)
        parser.add_argument('-name', type=str, required=True, help='Get scenario using name')
        return parser

    def take_action(self, parsed_args):
        httpClient = HTTPClient.get_Instance()
        req_url = ScenarioGetOne.scenario_url + "/" + parsed_args.name
        scenario = httpClient.get(req_url)
        print scenario
...
class ScenarioAddScore(ScenarioBase):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument('-scenario_version', type=str, required=True, help='Add Score by version name')
    ...
    def take_action(self, parsed_args):
        ...
        if(parsed_args.u and parsed_args.p):
            ...
            if "login" in response.text:
                print "Authentication has failed. Please check your username and password."
                return
        req_url = ScenarioAddScore.scenario_url + "/" + parsed_args.scenario + "/scores?installer=" + parsed_args.installer + "&version=" + parsed_args.scenario_version + "&project=" + parsed_args.project
...
class ScenarioAddTI(ScenarioBase):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument('-scenario_version', type=str, required=True, help='Add Trust Indicator by version name')
    ...
    def take_action(self, parsed_args):
        ...
        if(parsed_args.u and parsed_args.p):
            ...
            if "login" in response.text:
                print "Authentication has failed. Please check your username and password."
                return
        req_url = ScenarioAddTI.scenario_url + "/" + parsed_args.scenario + "/trust_indicators?installer=" + parsed_args.installer + "&version=" + parsed_args.scenario_version + "&project=" + parsed_args.project
...
class ScenarioAddCustom(ScenarioBase):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument('-scenario_version', type=str, required=True, help='Add custom by version name')
    ...
    def take_action(self, parsed_args):
        ...
        if(parsed_args.u and parsed_args.p):
            ...
            if "login" in response.text:
                print "Authentication has failed. Please check your username and password."
                return
        req_url = ScenarioAddCustom.scenario_url + "/" + parsed_args.scenario + "/customs?installer=" + parsed_args.installer + "&version=" + parsed_args.scenario_version + "&project=" + parsed_args.project
...
class ScenarioUpdateCustom(ScenarioBase):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument('-scenario_version', type=str, required=True, help='update custom by version name')
    ...
    def take_action(self, parsed_args):
        ...
        if(parsed_args.u and parsed_args.p):
            ...
            if "login" in response.text:
                print "Authentication has failed. Please check your username and password."
                return
        req_url = ScenarioUpdateCustom.scenario_url + "/" + parsed_args.scenario + "/customs?installer=" + parsed_args.installer + "&version=" + parsed_args.scenario_version + "&project=" + parsed_args.project
...
class ScenarioDeleteCustom(ScenarioBase):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument('-scenario_version', type=str, required=True, help='Delete custom by version name')
    ...
    def take_action(self, parsed_args):
        ...
        if(parsed_args.u and parsed_args.p):
            ...
            if "login" in response.text:
                print "Authentication has failed. Please check your username and password."
                return
        req_url = ScenarioDeleteCustom.scenario_url + "/" + parsed_args.scenario + "/customs?installer=" + parsed_args.installer + "&version=" + parsed_args.scenario_version + "&project=" + parsed_args.project
...
class ScenarioAddProject(ScenarioBase):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument('-scenario_version', type=str, required=True, help='Add project by scenario_version name')
    ...
    def take_action(self, parsed_args):
        ...
        if(parsed_args.u and parsed_args.p):
            ...
            if "login" in response.text:
                print "Authentication has failed. Please check your username and password."
                return
        req_url = ScenarioAddProject.scenario_url + "/" + parsed_args.scenario + "/projects?installer=" + parsed_args.installer + "&version=" + parsed_args.scenario_version
...
class ScenarioUpdateProject(ScenarioBase):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument('-scenario', type=str, required=True, help='Add project by scenario name')
        parser.add_argument('-installer', type=str, required=True, help='Add project by installer name')
        parser.add_argument('-scenario_version', type=str, required=True, help='Add project by version name')
        parser.add_argument('project', type=json.loads, help='''Project create request format :
        \'{"project": "","customs": [],"scores": [],"trust_indicators": []}\'''')
        return parser
...
class ScenarioDeleteProject(ScenarioBase):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument('-scenario_version', type=str, required=True, help='Delete project by version name')
    ...
    def take_action(self, parsed_args):
        ...
        if(parsed_args.u and parsed_args.p):
            ...
            if "login" in response.text:
                print "Authentication has failed. Please check your username and password."
                return
        req_url = ScenarioDeleteProject.scenario_url + "/" + parsed_args.scenario + "/projects?installer=" + parsed_args.installer + "&version=" + parsed_args.scenario_version
...
class ScenarioDeleteVersion(ScenarioBase):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument('-scenario_version', required=True, help='Delete version by version name')
        return parser
    ...
    def take_action(self, parsed_args):
        ...
        if(parsed_args.u and parsed_args.p):
            ...
            if "login" in response.text:
                ...
                return
        req_url = ScenarioPutVersion.scenario_url + "/" + parsed_args.scenario + "/versions?installer=" + parsed_args.installer
        response = httpClient.delete(req_url, User.session, ast.literal_eval(parsed_args.scenario_version))
        print response

...
from testapiclient.cli import installers
...
class InstallerCreateTest(InstallerTest):
    ...
    def test_create_success(self):
        ...
        installer_create = installers.InstallerCreate(self.app, mock.Mock())
        args = ['--scenario-name', 'scenario1', self.installer_string]
        verifies = [
...
class InstallerDeleteTest(InstallerTest):
    ...
    def test_delete_success(self):
        ...
        installer_delete = installers.InstallerDelete(self.app, mock.Mock())
        args = ['--scenario-name', 'scenario1', 'def']
        verifies = [('scenario_name', 'scenario1'), ('name', ['def'])]
...
class InstallerPutTest(InstallerTest):
    ...
    def test_put_success(self):
        self.put_mock.return_value = fakes.FakeResponse(
            data=None)
        installer_put = installers.InstallerPut(self.app, mock.Mock())
        args = ['--scenario-name', 'scenario1', self.installer_string]
        verifies = [
            ('scenario_name', 'scenario1'),
            ('installer', self.installer_json)]

...
class DeployResultBase(base.TestBase):
    ...
    def setUp(self):
        ...
        self.req_d = deploy_result_models.DeployResultCreateRequest.from_dict(
        ...
        self.get_res = deploy_result_models.DeployResult
        self.list_res = deploy_result_models.DeployResults

...
class TestResultBase(base.TestBase):
    ...
    def setUp(self):
        ...
        self.req_d = result_models.ResultCreateRequest.from_dict(
...
class TestResultCreate(TestResultBase):
    ...
    def test_no_ti(self):
        req = copy.deepcopy(self.req_d)
        req.trust_indicator = result_models.TI(0)
        self.actual_req = req
        return req
...
class TestResultUpdate(TestResultBase):
    ...
    def test_success(self):
        ...
        self.after_update.trust_indicator.histories.append(
            result_models.TIHistory(update_date, update_step))
        update = result_models.ResultUpdateRequest(

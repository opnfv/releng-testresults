...
(function () {
     ...
     * through testcases declared in TestAPI.
     */
    function TestCasesController($scope, $http, $filter, $state, $window, $uibModal, testapiApiUrl,
        ...
        */
        ...
        function openCreateModal(name){
                $uibModal.open({
                    templateUrl: 'testapi-ui/components/projects/project/testcases/createUpdateModal.html',
        ...
        function openUpdateTestModal(name){
            var testcase;
            var index;
            for(index in ctrl.testCases.testcases){
                if(ctrl.testCases.testcases[index].name==name){
                    testcase = ctrl.testCases.testcases[index]
                    continue
                }
            }
            $uibModal.open({
